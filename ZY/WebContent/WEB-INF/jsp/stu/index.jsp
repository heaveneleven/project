...
<body id="main_layout" class="easyui-layout">   
	...
	<div data-options="region:'north',href:'<%=basePath%>stu/layout/north'"
		style="height: 110px; overflow: hidden;" class="logo"></div>
	<div
		data-options="region:'south',href:'<%=basePath%>stu/layout/south',border:false"
		style="height: 30px; overflow: hidden;"></div>

	<div data-options="region:'west',href:'<%=basePath%>stu/layout/west/myInfo',split:true,iconCls:'icon-house',split: false" title="我的信息"
