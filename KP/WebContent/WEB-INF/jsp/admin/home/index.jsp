...
<body id="main_layout" class="easyui-layout">   
	...
	<div data-options="region:'north',href:'<%=basePath%>desktop/layout/admin/north'"
		style="height: 70px; overflow: hidden;" class="logo"></div>
	<div
		data-options="region:'south',href:'<%=basePath%>desktop/layout/admin/south',border:false"
		style="height: 30px; overflow: hidden;"></div>

	<%-- <div data-options="region:'east',title:'East',split:true,href:'<%=basePath%>jsp/sys/east'"
		style="width:100px;"></div> --%>

	<div data-options="region:'west',href:'<%=basePath%>desktop/layout/admin/nav',split:true,iconCls:'icon-house',split: false" title="导航"
