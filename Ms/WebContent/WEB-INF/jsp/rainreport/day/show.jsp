...
<script src="<%=basePath%>js/rainreport/day/show.js?<%=Math.random()%>" type="text/javascript" charset="utf-8"></script>  
	...
	<div class="main">
				...
				<div class="content" style="overflow:auto;">
					<div style="height:30px; background:#87B7DA;padding : 4px;font-size:16px;color:#3B5888;">
						<label>日降水量报表&nbsp;&nbsp;&nbsp; <b>${date}</b>
						</label>
						<button id="export" style="height:25px;float : right;font-size:11px;">导出Excel</button>
				   </div>
					<table id="daylist" style="width:800px;margin:0px auto;"></table>
				</div>
	</div>
