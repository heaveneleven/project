$(function(){
	$("#list").jqGrid({ 
		url:"setting/table.do?type=base",
		caption: "水位基值设置",
		height : 'auto',
		datatype: "json", 
		colNames:['基站编码', '基站名','测站类型','交换管理单位','水位基值','操作'],
		colModel:[
		           ...
		           {name:'base',index:'base', width:'60',align:'center',editable:true,
		        	   formatter:function(value,options,row){
		        		   if(value==null)
		        			     return '0.00';
		        		    else
        ...
        editurl: "setting/baseHigh/save.do"
