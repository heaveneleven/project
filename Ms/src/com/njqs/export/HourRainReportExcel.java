...
/** 导出时段降水量报表Excel */
public class HourRainReportExcel extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> obj,
		...
		HSSFSheet sheet = workbook.createSheet("时段报表");
		/** 添加头部标题 */
		...
		ce.setCellValue(date); // 表格的第一行第一列显示的数据
		...
		String filename = date;// 设置下载时客户端Excel的名称
