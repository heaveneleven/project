...
/** 导出日降水量报表Excel */
public class DayRainReportExcel extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> obj,
		...
		HSSFSheet sheet = workbook.createSheet("日降水量报表");
		...
		ce.setCellValue(date + "   日降水报表"); // 表格的第一行第一列显示的数据
		...
		String filename = date + "日降水报表.xls";// 设置下载时客户端Excel的名称
